...
File: quantization/int4/benchmark.py
...
Description:
    ...
    INT4 simulated quantization produces a standard FP32 model, so
...
class InferenceBenchmark:
    """Measure top-1 accuracy and inference time for an INT4-quantized ViT.
