...
File: quantization/int4/plotter.py

Description:
    Two-panel bar chart comparing accuracy and model size between the
    FP32 baseline and the INT4 weight-only quantized variant.
"""
...
_BAR_COLORS: list[str] = ["#4C72B0", "#55A868"]


class QuantizationPlotter:
    """Generate a comparison figure for FP32 vs INT4."""
    ...
    def plot(
        ...
        The two panels show:
            1. Top-1 accuracy (%).
            2. Model size in megabytes (actual for FP32, theoretical for INT4).
        ...
        fig.suptitle(
            "Quantization Comparison: FP32 vs INT4 (W4A32)",
            fontsize=14,
            fontweight="bold",
        )
