...
File: quantization/int1/benchmark.py
...
Description:
    ...
    INT1 simulated quantization produces a standard FP32 model, so
...
class InferenceBenchmark:
    """Measure top-1 accuracy and inference time for an INT1-quantized ViT.
