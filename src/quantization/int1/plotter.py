...
File: quantization/int1/plotter.py

Description:
    Two-panel bar chart comparing accuracy and model size between the
    FP32 baseline and the INT1 binary weight quantized variant.
"""
...
_BAR_COLORS: list[str] = ["#4C72B0", "#C44E52"]


class QuantizationPlotter:
    """Generate a comparison figure for FP32 vs INT1 (binary)."""
    ...
    def plot(
        ...
        The two panels show:
            1. Top-1 accuracy (%).
            2. Model size in megabytes (actual for FP32, theoretical for INT1).
        ...
        fig.suptitle(
            "Quantization Comparison: FP32 vs INT1 (Binary, XNOR-Net)",
            fontsize=14,
            fontweight="bold",
        )
